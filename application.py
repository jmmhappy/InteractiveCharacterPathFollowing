...
class RunApp(wx.App):
    def __init__(self, args):
        ...
        if extension == ".bin":
            ...
            self.window.appendRenderer('skeleton', SkelRenderer(dataPath))
        elif extension == "":
            self.window.appendRenderer('particle', ParticleRenderer('cube'))
#            self.window.appendRenderer('particle', ParticleRenderer('dot'))
        else:
        ...
        if data:
            for i in range(characters):
                ...
                self.window.appendRenderer(name, MotionRenderer(mstream))
